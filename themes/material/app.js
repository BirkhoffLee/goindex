...
function file(path) {
  ...
  let url = window.location.origin + path.split('/').map(encodeUrl).join('/')
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML code</label>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <input class="mdui-textfield-input" type="text" value="<img src='${url}' />"/>
        ...
        <div class="mdui-textfield">
	  <label class="mdui-textfield-label">Markdown code</label>
	  <input class="mdui-textfield-input" type="text" value="![](${url})"/>
	</div>
        <br>
</div>
